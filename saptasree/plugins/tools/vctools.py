...
from saptasree import app, Userbot
...
async def strcall(client, message):
    ...
    try:
        await assistant.join_group_call(message.chat.id, AudioPiped("./saptasree/assets/call.mp3"), stream_type=StreamType().pulse_stream)
