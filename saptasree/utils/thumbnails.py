...
async def get_thumb(videoid):
    ...
    arial = ImageFont.truetype("saptasree/assets/assets/font2.ttf", 30)
    font = ImageFont.truetype("saptasree/assets/assets/font.ttf", 30)
    title_font = ImageFont.truetype("saptasree/assets/assets/font3.ttf", 45)
    ...
    play_icons = Image.open("saptasree/assets/assets/play_icons.png")
